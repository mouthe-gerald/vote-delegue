        ...
        <div className="bg-slate-800 border border-white/10 rounded-2xl p-8">
          ...
          {etape === 0 && (
            <>
              <div className="text-center mb-6">
                ...
                <h2 className="text-xl font-extrabold text-white mb-1">Mot de passe oublié</h2>
                <p className="text-slate-400 text-sm">Entrez votre matricule ou email pour recevoir un code.</p>
              </div>
              ...
              <form onSubmit={envoyerCode} className="flex flex-col gap-4">
                <div>
                  <label className="text-slate-400 text-xs mb-1.5 block">Matricule ou Email</label>
                  <div className="relative">
                    ...
                    <input type="text" placeholder="CM-UDS-24IUT0001 ou email@..."
                      ...
                      className="w-full pl-9 pr-4 py-3 rounded-xl text-sm text-white bg-white/5 border border-white/10 outline-none placeholder-slate-600 focus:border-amber-500/50 transition-colors"
                      required />
                  </div>
                </div>
          ...
          {etape === 1 && (
            <>
              <div className="text-center mb-6">
                ...
                <h2 className="text-xl font-extrabold text-white mb-1">Réinitialiser</h2>
              ...
              <form onSubmit={reinitialiser} className="flex flex-col gap-4">
                <div>
                  <label className="text-slate-400 text-xs mb-2 block text-center">Code de vérification</label>
                ...
                <div>
                  <label className="text-slate-400 text-xs mb-1.5 block">Nouveau mot de passe</label>
                  <div className="relative">
                    ...
                    <input type={showPwd ? 'text' : 'password'} placeholder="Min. 8 caractères"
                      ...
                      className="w-full pl-9 pr-10 py-3 rounded-xl text-sm text-white bg-white/5 border border-white/10 outline-none placeholder-slate-600 focus:border-amber-500/50 transition-colors"
                      required />
          ...
          {etape === 2 && (
            <div className="text-center flex flex-col items-center gap-4">
              ...
              <p className="text-slate-400 text-sm">Vous pouvez maintenant vous connecter avec votre nouveau mot de passe.</p>
