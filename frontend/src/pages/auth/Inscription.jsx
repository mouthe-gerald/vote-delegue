        ...
        <div className="bg-gray-50 border border-gray-300 rounded-2xl p-8">
          ...
          {etape === 0 && (
            <form onSubmit={handlePreInscription} className="flex flex-col gap-4">
              ...
              <div>
                <label className="text-gray-500 text-xs mb-1.5 block">Mot de passe</label>
                <div className="relative">
          ...
          {etape === 1 && (
            <div className="text-center flex flex-col items-center gap-5">
              ...
              <div className="flex gap-4">
                <button onClick={renvoierOTP} className="text-gray-400 text-sm hover:text-amber-500 transition-colors">
                  Renvoyer le code
                </button>
