...
const PageVote = () => {
  ...
  if (etape === 'confirmation') return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="bg-white border border-gray-200 rounded-2xl p-8 text-center max-w-lg w-full">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 mb-6 text-left">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex justify-between pt-3 border-t border-gray-200">
              {[
                { label: 'Réseau',   value: 'Ethereum Local', color: 'text-gray-800' },
      ...
      <header className="bg-blue-50 border-b border-gray-200 px-4 sm:px-6 h-14 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-gray-800 font-bold text-sm">Vote — {election?.titre}</h1>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6">
              ...
              {candidats.map(candidat => (
                <div key={candidat.id} onClick={() => setSelectionne(candidat.id)}
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="w-14 h-14 bg-blue-50 rounded-xl overflow-hidden flex-shrink-0 flex items-center justify-center">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h3 className="text-gray-800 font-bold text-sm">{candidat.etudiant_nom}</h3>
                      </div>
        ...
        {etape === 'verification' && (
          <div className="flex flex-col items-center gap-6 py-6">
            ...
            <div className="text-center">
              <h2 className="text-gray-800 font-bold text-lg mb-2">Vérification biométrique</h2>
        ...
        {etape === 'succes' && (
          <div className="flex flex-col items-center gap-6 py-6 text-center">
            ...
            <div>
              <h2 className="text-gray-800 font-bold text-xl mb-2">Vote enregistré !</h2>
