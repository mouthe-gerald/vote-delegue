            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-left px-5 py-3.5 text-gray-400 text-xs font-semibold hidden sm:table-cell">Filière / Niveau</th>
                  <th className="text-left px-5 py-3.5 text-gray-400 text-xs font-semibold">Rôle</th>
                  <th className="text-left px-5 py-3.5 text-gray-400 text-xs font-semibold hidden md:table-cell">Statut</th>
                  <th className="text-left px-5 py-3.5 text-gray-400 text-xs font-semibold">Actions</th>
                </tr>
              </thead>
              <tbody>
                {loading ? (
