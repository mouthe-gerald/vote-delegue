            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
                {[
                  {
                    label: 'Votes reçus',
                    value: resultat?.nb_voix ?? '—',
                    icon: Vote,
                    color: 'bg-purple-600',
                  },
                  {
                    label: 'Position',
                    value: resultat ? `#${resultat.rang || '?'}` : '—',
                    icon: Trophy,
                    color: 'bg-yellow-500',
                  },
                  {
                    label: 'Pourcentage',
                    value: resultat ? `${resultat.pourcentage}%` : '—',
                    icon: Percent,
                    color: 'bg-green-500',
                  },
                  {
                    label: 'Statut élection',
                    value: election?.statut?.replace('_', ' ') || '—',
                    icon: Clock,
                    color: 'bg-blue-500',
                  },
                ].map((stat, i) => (
              ...
              {candidature && (
                <div className="bg-white rounded-2xl shadow-sm p-6">
                  ...
                  <div className="flex items-center gap-4">
                    <span className={`px-4 py-2 rounded-xl font-bold ${statutColor[candidature.statut]}`}>
                      {candidature.statut.replace('_', ' ')}
                    </span>
