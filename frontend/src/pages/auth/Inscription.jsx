...
const Inscription = () => {
  ...
  return (
    <div className="min-h-screen bg-white shadow-sm flex items-center justify-center px-4 py-12 relative">
      <style>{`
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white shadow-sm border border-slate-200 rounded-2xl p-8">
          ...
          <div className="text-center mb-8">
            <h2 className="text-2xl font-extrabold text-slate-700 mb-1 fade1">Créer un compte</h2>
            <p className="text-slate-500 text-sm">Plateforme de Vote en Ligne</p>
          </div>
          ...
          <div className="flex items-center justify-center mb-8">
            {ETAPES.map((e, i) => (
              <div key={i} className="flex items-center">
                ...
                {i < ETAPES.length - 1 && (
                  <div className={`w-12 h-0.5 mx-1 transition-all ${i < etape ? 'bg-amber-500' : 'bg-slate-800'}`} />
                )}
              </div>
            ))}
          </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input placeholder="Prénom" value={form.prenom}
                      ...
                      className="w-full pl-9 pr-3 py-3 rounded-xl text-sm text-slate-700 outline-none border border-slate-200 bg-slate-800 placeholder-gray-400" required />
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select value={form.filiere} onChange={e => setForm({...form, filiere: e.target.value})}
                      className="w-full pl-9 pr-3 py-3 rounded-xl text-sm text-slate-700 outline-none border border-slate-200 bg-slate-100 appearance-none" required>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type={showPwd ? 'text' : 'password'} placeholder="Min. 8 caractères"
                    ...
                    className="w-full pl-9 pr-10 py-3 rounded-xl text-sm text-slate-700 outline-none border border-slate-200 bg-slate-800 placeholder-gray-400" required />
          ...
          {etape === 1 && (
            <div className="text-center flex flex-col items-center gap-5">
              ...
              <div>
                <h3 className="text-lg font-bold text-slate-700 mb-1">Vérifiez votre email</h3>
              ...
              <div className="flex gap-4">
                <button onClick={renvoierOTP} className="text-slate-400 text-sm hover:text-amber-500 transition-colors">
                  Renvoyer le code
                </button>
          ...
          {etape === 2 && (
            <div className="flex flex-col items-center gap-5">
              ...
              <div className="w-full bg-slate-8000/10 border border-blue-500/20 rounded-xl p-3 text-blue-400 text-xs text-center">
              ...
              {!empreinteOk ? (
                ...
                <button onClick={terminerInscription}
                  className="w-full bg-emerald-600 text-slate-700 py-3.5 rounded-xl font-bold text-sm hover:bg-emerald-500 transition-all flex items-center justify-center gap-2">
