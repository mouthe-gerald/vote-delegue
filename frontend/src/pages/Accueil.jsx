...
const Accueil = () => {
  ...
  return (
    <div className="font-sans text-slate-900">
      ...
      {/* NAVBAR */}
      <nav className={`fixed top-0 left-0 right-0 z-50 border-b-2 border-amber-500 transition-all duration-300 ${scrolled ? 'bg-white shadow-sm/95 backdrop-blur-md shadow-lg' : 'bg-white shadow-sm'}`}>
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-slate-700 font-bold text-base">VotingApp</span>
          </div>
          <div className="hidden md:flex items-center gap-6">
            <a href="#apropos" className="nav-link text-slate-500 hover:text-slate-700 text-sm transition-colors">À propos</a>
            <a href="#fonctionnalites" className="nav-link text-slate-500 hover:text-slate-700 text-sm transition-colors">Fonctionnalités</a>
            <a href="#contact" className="nav-link text-slate-500 hover:text-slate-700 text-sm transition-colors">Contact</a>
            <Link to="/resultats" className="nav-link text-slate-500 hover:text-slate-700 text-sm transition-colors">Résultats</Link>
            ...
            <button onClick={() => navigate('/connexion')}
              className="btn-connecter text-slate-700 px-4 py-2 rounded-lg text-sm font-bold transition-all duration-200">
        ...
        {menuOpen && (
          <div className="md:hidden bg-white shadow-sm border-t border-slate-700 px-4 py-4 flex flex-col gap-3 slide-down">
            <a href="#apropos" className="text-slate-600 text-sm py-2 hover:text-amber-500 transition-colors" onClick={() => setMenuOpen(false)}>À propos</a>
            <a href="#fonctionnalites" className="text-slate-600 text-sm py-2 hover:text-amber-500 transition-colors" onClick={() => setMenuOpen(false)}>Fonctionnalités</a>
            <a href="#contact" className="text-slate-600 text-sm py-2 hover:text-amber-500 transition-colors" onClick={() => setMenuOpen(false)}>Contact</a>
            <Link to="/resultats" className="text-slate-600 text-sm py-2 hover:text-amber-500 transition-colors" onClick={() => setMenuOpen(false)}>Résultats</Link>
      ...
      {/* HERO */}
      <section className="min-h-screen bg-white shadow-sm flex items-center pt-16 relative">
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          <div>
            ...
            <h1 className="fade2 text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-700 leading-normal mb-6">
              Election<br />
              <span className="text-amber-500">Transparente</span>
            </h1>
            <p className="fade3 text-slate-500 text-lg leading-relaxed mb-8 max-w-lg">
            ...
            <div className="fade5 flex gap-8 pt-8 border-t border-slate-200">
          ...
          <div className="fade3 bg-white border border-gray-200 rounded-2xl p-6 shadow-lg">
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                <div key={i} className="flex items-center gap-3 p-3 rounded-xl bg-white shadow-sm border border-slate-200 hover:bg-white shadow-sm/8 hover:border-slate-200 transition-all duration-200 cursor-default group">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-slate-700 text-xs font-semibold">{f.label}</div>
      ...
      <section id="apropos" className="bg-gray-50 py-24 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-slate-400 text-xs font-semibold tracking-widest uppercase">À propos</span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="scroll-anim card-hover bg-white shadow-sm rounded-xl p-6 border border-slate-100" style={{borderTop:`3px solid ${c.color}`}}>
      ...
      {/* FONCTIONNALITÉS */}
      <section id="fonctionnalites" className="bg-white shadow-sm py-24 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-1 h-8 bg-amber-500 rounded-full" />
            <span className="text-slate-400 text-xs font-semibold tracking-widest uppercase">Fonctionnalités</span>
          </div>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mb-4">Tout ce dont vous avez besoin</h2>
          <p className="text-slate-400 text-lg max-w-md leading-relaxed mb-14">Une suite complète d'outils pour organiser, sécuriser et analyser les élections.</p>
      ...
      {/* CONTACT */}
      <section id="contact" className="bg-white shadow-sm py-24 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            <div className="flex items-center gap-3 mb-3">
              <div className="w-1 h-8 bg-amber-500 rounded-full" />
              <span className="text-slate-400 text-xs font-semibold tracking-widest uppercase">Contact</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-700 mb-4">Une question ?<br />Contactez-nous</h2>
            <p className="text-slate-500 text-base leading-relaxed mb-10">L'équipe de développement est disponible pour toute question relative à la plateforme.</p>
              ...
              {[
                ...
                <div key={i} className="flex gap-4 items-start group">
                  ...
                  <div>
                    ...
                    <div className="text-slate-700 text-sm font-medium">{c.value}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <form onSubmit={handleContact} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-lg hover:border-blue-300 transition-colors duration-300">
            ...
            <div className="flex flex-col gap-4">
              ...
              <textarea placeholder="Votre message" rows={5} value={contactForm.message} onChange={e => setContactForm({...contactForm,message:e.target.value})} className="border border-slate-200 rounded-lg px-4 py-3 text-slate-700 text-sm outline-none placeholder-gray-400 resize-none focus:border-amber-500/50 transition-colors w-full" style={{background:'rgba(255,255,255,0.06)'}} />
      ...
      <footer className="bg-blue-900 border-t border-blue-800 py-8 px-4 text-center">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <span className="text-slate-700 font-semibold text-sm">VotingApp</span>
        </div>
      </footer>
    </div>
  )
